		...
		<div class="space-y-8">
			...
			>
				...
				>
					...
					>
						<path
							...
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-wordpress1"
						/>
					</svg>
					<p class="py-3 text-black dark:text-gray-200">WordPress</p>
				</div>
				<!-- Tailwind CSS -->
				<div
					v-motion-pop-visible-once
				...
				>
					...
					>
						<path
							...
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-scss1"
						/>
						<path
					...
					<p class="py-3 text-black dark:text-gray-200">SCSS</p>
				</div>
				<!-- GSAP -->
				<div
					v-motion-pop-visible-once
				...
				>
					...
					>
						<circle
							...
							cy="16"
							r="14"
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-jquery1"
						/>
						<path
							...
							class="fill-white dark:fill-gray-700 transition ease-in-out duration-300 group-hover:fill-jquery2"
						/>
						<path
					...
					<p class="py-3 text-black dark:text-gray-200">jQuery</p>
				</div>
				<!-- Axios -->
				<div
					v-motion-pop-visible-once
				...
				>
					...
					>
						<path
							...
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-axios1"
						/>
						<path
					...
					<p class="py-3 text-black dark:text-gray-200">Axios</p>
				</div>
				<!-- Figma -->
				<div
					v-motion-pop-visible-once
				...
				>
					...
					>
						<path
							...
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-figma1"
						/>
						<path
							d="M8 24C8 21.7909 9.79086 20 12 20H16V24C16 26.2091 14.2091 28 12 28C9.79086 28 8 26.2091 8 24Z"
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-figma2"
						/>
						<path
							d="M16 4V12H20C22.2091 12 24 10.2091 24 8C24 5.79086 22.2091 4 20 4H16Z"
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-figma3"
						/>
						<path
							d="M8 8C8 10.2091 9.79086 12 12 12H16V4H12C9.79086 4 8 5.79086 8 8Z"
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-figma4"
						/>
						<path
							d="M8 16C8 18.2091 9.79086 20 12 20H16V12H12C9.79086 12 8 13.7909 8 16Z"
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-figma5"
						/>
					</svg>
					<p class="py-3 text-black dark:text-gray-200">Figma</p>
				</div>
				<!-- Git -->
				<div
					v-motion-pop-visible-once
				...
				>
					...
					>
						<path
							...
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-git1"
						/>
						<path
					...
					<p class="py-3 text-black dark:text-gray-200">Git</p>
				</div>
				<!-- NPM -->
				<div
					v-motion-pop-visible-once
				...
				>
					...
					>
						<path
							...
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-npm1"
						/>
						<path
					...
					<p class="py-3 text-black dark:text-gray-200">NPM</p>
				</div>
				<!-- ESLint -->
				<div
					v-motion-pop-visible-once
				...
				>
					...
					>
						<path
							...
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-eslint1"
						/>
						<polygon
							points="21.802 19.188 16.055 22.423 10.313 19.188 10.313 12.718 16.055 9.482 21.802 12.718 21.802 19.188"
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-eslint2"
						/>
					</svg>

					<p class="py-3 text-black dark:text-gray-200">ESLint</p>
				</div>
				<!-- Prettier -->
				<div
					v-motion-pop-visible-once
				...
				>
					...
					>
						<rect
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-prettier1"
							x="182.857143"
							y="48.7619048"
							width="24.3809524"
							height="12.1904762"
						...
						></rect>
						<rect
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-prettier2"
							x="0"
							y="243.809524"
							width="73.1428571"
							height="12.1904762"
						...
						></rect>
						<rect
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-prettier3"
							x="146.285714"
							y="146.285714"
							width="48.7619048"
							height="12.1904762"
						...
						></rect>
						<rect
							class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-prettier4"
							x="60.952381"
							y="24.3809524"
							width="134.095238"
							height="12.1904762"
						...
						></rect>
						<rect
							class="fill-white dark:fill-gray-700 transition ease-in-out duration-300 group-hover:fill-prettier5"
							opacity="0.5"
							x="158.47619"
							y="219.428571"
							width="24.3809524"
					...
					<p class="py-3 text-black dark:text-gray-200">Prettier</p>
				</div>
				<!-- Webpack -->
				<div
					v-motion-pop-visible-once
				...
				>
					...
					>
						<polygon
							...
							class="fill-black dark:fill-white transition ease-in-out duration-300 group-hover:fill-white"
						></polygon>
						<path
							...
							class="fill-gray-200 dark:fill-black transition ease-in-out duration-300 group-hover:fill-webpack1"
						></path>
						<path
							...
							class="fill-gray-200 dark:fill-black transition ease-in-out duration-300 group-hover:fill-webpack2"
						></path>
					</svg>
					<p class="py-3 text-black dark:text-gray-200">Webpack</p>
				</div>
				...
				>
					<svg
						...
						xml:space="preserve"
						class="fill-current w-14 h-14 group grayscale transition ease-in-out duration-300 hover:scale-150 hover:grayscale-0"
					>
						<g>
							<g>
								<path
