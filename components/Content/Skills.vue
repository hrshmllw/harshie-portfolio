        ...
        >
          ...
          >
            <path
              ...
              class="fill-white dark:fill-gray-700 transition ease-in-out duration-300 group-hover:fill-black dark:transition dark:ease-in-out dark:duration-300 dark:group-hover:fill-white"
            />
            <path
              ...
              class="fill-black dark:fill-gray-200 transition ease-in-out duration-300 group-hover:fill-black dark:transition dark:ease-in-out dark:duration-300 dark:group-hover:fill-white"
            />
            <path
