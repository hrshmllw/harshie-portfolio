<template>
	<section
		class="flex flex-col justify-center p-6 mx-auto lg:flex-row gap-4 xl:my-auto lg:justify-between h-screen max-w-7xl dark:text-gray-200"
	>
		<div
			class="flex flex-col justify-center text-center lg:text-left pt-20 lg:w-1/2 mx-auto"
		>
			<h1
				class="text-5xl font-bold leadi md:text-6xl lg:text-8xl flex flex-col"
			>
				<span
					v-motion
			...
			<p class="mt-6 mb-8 text-3xl sm:mb-6 font-poppins">Frontend Developer</p>
