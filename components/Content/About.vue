    ...
    >
      ...
      <div class="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
        <div v-motion-slide-visible-once-right class="lg:col-start-2">
          ...
          <p class="mt-3 text-lg dark:text-gray-200">
            Throughout my academic journey, I explored different fields, but
            focused mainly on web development. During an internship, I learned
            and used Vue.js and now, I mostly use Nuxt.js.
          </p>
          <p class="mt-3 text-lg dark:text-gray-200">
            I am currently working on small personal projects and exploring
            different frameworks and tools for web development.
          </p>
          <p class="mt-3 text-lg dark:text-gray-200">
            When I'm not in front of the computer, I mostly spend time with my
            adorable daughter. I also play video games, watch movies and TV
            series, and sometimes build and mod mechanical keyboards.
          </p>
          <p class="mt-3 text-lg dark:text-gray-200">
            If you like to get in touch, click
          ...
          <div class="my-12">
            <a
              ...
              class="p-3 rounded-md transition ease-in-out duration-300 hover:ring hover:animate-pulse ring-gray-200 bg-primary text-gray-200"
              >Download Resume</a
            >
          </div>
        </div>
