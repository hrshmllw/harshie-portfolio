	...
	>
		<div class="flex flex-wrap items-center justify-between mx-auto p-4n">
			...
			<div class="hidden md:block md:px-10 lg:px-24">
				<ul class="flex space-x-8 text-lg text-semibold text-gray-200">
			...
			<!-- Drawer Menu -->
			<aside
				class="p-5 transform top-0 left-0 w-64 bg-gray-200 dark:bg-gray-800 fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30"
			...
			>
				...
				<span
					@click="isOpen = false"
					class="flex w-full items-center pb-4 text-lg text-semibold"
				>
					EJMacawili
				</span>

				<ul class="text-black dark:text-gray-200">
					<li>
						<a
							href="#"
							@click="isOpen = false"
